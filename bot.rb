      ...
      threads << Thread.new do
        ...
        plugins.each do |plugin|
          ...
          begin
            ...
            bot.api.sendMessage(chat_id: message.chat.id, text: "Not working")
          end
        end
        ...
        when '/start', "/start@#{bot_username}"
          bot.api.sendMessage(chat_id: message.chat.id, text: "Hai, #{message.from.first_name}, to start \n type /hack [your email]")
        when /josh/i
